...
/* ENET ********************************************************************* */
#ifdef CONFIG_MYIMX6MB140O_REVC
...
static iomux_v3_cfg_t const fec1_pads[] = {
    ...
    MX6_PAD_ENET2_RX_DATA1__ENET1_MDC   | MUX_PAD_CTRL(MDIO_PAD_CTRL),
    MX6_PAD_SNVS_TAMPER6__GPIO5_IO06    | MUX_PAD_CTRL(NO_PAD_CTRL),
    MX6_PAD_SNVS_TAMPER2__GPIO5_IO02    | MUX_PAD_CTRL(MDIO_PAD_CTRL),
#else
